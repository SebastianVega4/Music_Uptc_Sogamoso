...
export class SearchComponent {
  ...
  vote(track: any): void {
    const trackInfo = {
      name: track.name,
      artists: track.artists, // Esto ya es un array de strings en los resultados de búsqueda
      image: track.album?.images?.[0]?.url || track.image, // Asegurar que tenga imagen
